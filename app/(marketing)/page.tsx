        ...
        <div className="flex items-center justify-center flex-col text-black">
            <div className={cn("flex items-center justify-center flex-col",
                ...
                <div className="mb-4 flex items-center border shadow-sm p-4 bg-amber-100 text-amber-700 rounded-full uppercase">
                    ...
                    # 1 task management for Online schools!
                </div>
                <h1 className="text-3xl md:text-6xl text-center text-neutral-800 mb-6">Unimetrix helps online business move</h1>
            ...
            <div className={cn("text-small md:text-xl text-neutral-400 mt-4 max-w-xs md:max-w-2xl text-center mx-auto",textFont.className,)}>
                Collaborate, manage projects, and reach new productivity peaks. From hight rises to the home office, the way your team works is unique - accomplish it all with Unimetrix.
            </div>
            <Button className="mt-6" size={"lg"} asChild>
                <Link href="/sign-up">
                Get Unimetrix for free</Link>
            </Button>
        </div>
    )
}
